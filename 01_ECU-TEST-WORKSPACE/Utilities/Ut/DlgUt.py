...
[wxID_DLGUT, wxID_DLGUTBUTTON_CANCEL, wxID_DLGUTBUTTON_OK,
wxID_DLGUTSTATICTEXT1,
] = wx.NewIdRef(4)

class DlgUt(wx.Dialog):

    def __init__(self, parent, aTestStep):
        wx.Dialog.__init__(self, id=wxID_DLGUT, name='', parent=parent,
                           pos=wx.Point(407, 488), size=wx.Size(364, 193),
                           style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER, title='Ut')
